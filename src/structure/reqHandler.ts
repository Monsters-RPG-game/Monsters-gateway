...
import NarratorStory from './modules/narratorStory/handler.js';
import Npc from './modules/npc/handler.js';
import NpcStory from './modules/npcStory/handler.js';
...
export default class ReqHandler {
  ...
  constructor() {
    ...
    this.narratorStory = new NarratorStory(enums.EServices.Story, action);
